...
Puerto: **2220**.
Usuario: **bandit12**.
Contraseña: Encontrada en el nivel anterior: `JVNBBFSmZwKKOP0XbFXOoW8chDz5yVRv`.
...
bandit12@bandit:~$ 
bandit12@bandit:~$ mkdir /tmp/20201496
bandit12@bandit:~$ cd 20201496
-bash: cd: 20201496: No such file or directory
bandit12@bandit:~$ cd /tmp/20201496
bandit12@bandit:/tmp/20201496$ cp ~/data.txt
cp: missing destination file operand after '/home/bandit12/data.txt'
Try 'cp --help' for more information.
bandit12@bandit:/tmp/20201496$ cp ~/data.txt .
bandit12@bandit:/tmp/20201496$ file data
data: cannot open `data' (No such file or directory)
bandit12@bandit:/tmp/20201496$ xxd -r data.txt > data
bandit12@bandit:/tmp/20201496$ file data
...
bandit12@bandit:/tmp/20201496$ ls
data  data.txt
bandit12@bandit:/tmp/20201496$ rm data.txt
bandit12@bandit:/tmp/20201496$ ls
data
bandit12@bandit:/tmp/20201496$ DESCOMPRESION
DESCOMPRESION: command not found
bandit12@bandit:/tmp/20201496$ mv data data.gz
bandit12@bandit:/tmp/20201496$ ls
data.gz
bandit12@bandit:/tmp/20201496$ gzip -d data.gz
bandit12@bandit:/tmp/20201496$ ls
data
bandit12@bandit:/tmp/20201496$ file data
data: bzip2 compressed data, block size = 900k
bandit12@bandit:/tmp/20201496$ mv data data.bz2
bandit12@bandit:/tmp/20201496$ ls
data.bz2
bandit12@bandit:/tmp/20201496$ bzip2 -d data.bz2
bandit12@bandit:/tmp/20201496$ ls
data
bandit12@bandit:/tmp/20201496$ file data
...
bandit12@bandit:/tmp/20201496$ mv data data.tar
bandit12@bandit:/tmp/20201496$ ls
data.tar
bandit12@bandit:/tmp/20201496$ mv data data.gz
mv: cannot stat 'data': No such file or directory
bandit12@bandit:/tmp/20201496$ mv data.tar data.gz
bandit12@bandit:/tmp/20201496$ ls
data.gz
bandit12@bandit:/tmp/20201496$ gzip -d data.gz
bandit12@bandit:/tmp/20201496$ ls
data
bandit12@bandit:/tmp/20201496$ file ls
ls: cannot open `ls' (No such file or directory)
bandit12@bandit:/tmp/20201496$ file lsdata
lsdata: cannot open `lsdata' (No such file or directory)
bandit12@bandit:/tmp/20201496$ file data
data: POSIX tar archive (GNU)
bandit12@bandit:/tmp/20201496$ mv data data.tar
bandit12@bandit:/tmp/20201496$ ls
data.tar
bandit12@bandit:/tmp/20201496$ tar xf data.tar
bandit12@bandit:/tmp/20201496$ ls
data5.bin  data.tar
bandit12@bandit:/tmp/20201496$ rm data.tar
bandit12@bandit:/tmp/20201496$ ls
data5.bin
bandit12@bandit:/tmp/20201496$ file data5.bin
data5.bin: POSIX tar archive (GNU)
bandit12@bandit:/tmp/20201496$ mv data5.bin data5.tar
bandit12@bandit:/tmp/20201496$ ls
data5.tar
bandit12@bandit:/tmp/20201496$ tar xf data5.tar
bandit12@bandit:/tmp/20201496$ ls
data5.tar  data6.bin
bandit12@bandit:/tmp/20201496$ rm data5.tar
bandit12@bandit:/tmp/20201496$ ls
data6.bin
bandit12@bandit:/tmp/20201496$ file data6.bin
data6.bin: bzip2 compressed data, block size = 900k
bandit12@bandit:/tmp/20201496$ mv data6.bin data6.bz2
bandit12@bandit:/tmp/20201496$ ls
data6.bz2
bandit12@bandit:/tmp/20201496$ bzip2 -d data6.bz2
bandit12@bandit:/tmp/20201496$ ls
data6
bandit12@bandit:/tmp/20201496$ file data6
data6: POSIX tar archive (GNU)
bandit12@bandit:/tmp/20201496$ mv data6 data6.tar
bandit12@bandit:/tmp/20201496$ ls
data6.tar
bandit12@bandit:/tmp/20201496$ tar xf data6.tar
bandit12@bandit:/tmp/20201496$ ls
data6.tar  data8.bin
bandit12@bandit:/tmp/20201496$ rm data6.tar
bandit12@bandit:/tmp/20201496$ ls
data8.bin
bandit12@bandit:/tmp/20201496$ file data8.bin
data8.bin: gzip compressed data, was "data9.bin", last modified: Thu Oct  5 06:19:20 2023, max compression, from Unix, original size modulo 2^32 49
bandit12@bandit:/tmp/20201496$ mv data8.bin data8.gz
bandit12@bandit:/tmp/20201496$ ls
data8.gz
bandit12@bandit:/tmp/20201496$ gzip -d data8.gz
bandit12@bandit:/tmp/20201496$ file data8
data8: ASCII text
bandit12@bandit:/tmp/20201496$ cat data8
The password is wbWdlBxEir4CaE8LaPhauuOo6pwRmrDw
bandit12@bandit:/tmp/20201496$ 

```

## Notas adicionales

Se hicieron descompresiones entre diferentes tipos de extenciones.
- `zcat` -> gzip -d `nombre_archivo.gz`
- `bzcat` -> bzip2 -d `nombre_archivo.bz2`
- `tarx` -> tar xf `nombre_archivo.tar`
- `mv` -> Cambia la extensión/tipo de archivo que estemos modificando. Se acompaña de:` nombre actual del archivo`+ `espacio` + `nuevo nombre del archivo con su nueva extension`.
## Referencias
