...
Puerto: **2220**.
Usuario: **bandit13**.
Contraseña: Encontrada en el nivel anterior: `wbWdlBxEir4CaE8LaPhauuOo6pwRmrDw`.
...
`cat` -> Muestra el contenido del archivo que se le debe indicar después, que en este caso es un directorio que se nos indico en las instrucciones del juego (`/etc/bandit_pass/bandit14).
``
## Referencias
